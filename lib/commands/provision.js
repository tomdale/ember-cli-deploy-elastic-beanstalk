...
module.exports = {
  ...
  run: function() {
    ...
    this.ui.writeLine(chalk.green('Provisioning Elastic Beanstalk application\n'));

    return this.askQuestions()
      .then(this.createApplicationIfNeeded.bind(this))
      .then(this.createApplicationVersion.bind(this))
      .then(this.createEnvironment.bind(this))
      .then(this.waitForEnvironment.bind(this));
  },
